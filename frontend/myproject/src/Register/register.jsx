            ...
            <div className="md:col-span-3 p-8">
              ...
              <form onSubmit={handleSubmit(handleForm)} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        id="name"
                        type="text"
                        className={`w-full bg-gray-50 border pl-10 pr-4 py-2.5 rounded-xl text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-gray-500/50 focus:border-gray-500 transition duration-200 outline-none ${errors.name ? "border-red-500/50" : "border-gray-200"
                          }`}
                  ...
                  {/* User ID */}
                  <div className="space-y-1.5">
                    <label htmlFor="userid" className="text-xs font-semibold text-gray-600 uppercase tracking-wider ml-1">
                      User ID
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-500">
                      ...
                      <input
                        ...
                        id="userid"
                        type="text"
                        className={`w-full bg-gray-50 border pl-10 pr-4 py-2.5 rounded-xl text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-gray-500/50 focus:border-gray-500 transition duration-200 outline-none ${errors.userid ? "border-red-500/50" : "border-gray-200"
                          }`}
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      id="email"
                      type="email"
                      className={`w-full bg-gray-50 border pl-10 pr-4 py-2.5 rounded-xl text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-gray-500/50 focus:border-gray-500 transition duration-200 outline-none ${errors.email ? "border-red-500/50" : "border-gray-200"
                        }`}
                ...
                {/* Password */}
                <div className="space-y-1.5">
                  <label htmlFor="password" className="text-xs font-semibold text-gray-600 uppercase tracking-wider ml-1">
                    Password
                  </label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-500">
                    ...
                    <input
                      ...
                      className={`w-full bg-gray-50 border pl-10 pr-10 py-2.5 rounded-xl text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-gray-500/50 focus:border-gray-500 transition duration-200 outline-none ${errors.password ? "border-red-500/50" : "border-gray-200"
                        }`}
                      placeholder="••••••••"
                    />
                    <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Roll Number */}
                  <div className="space-y-1.5">
                    <label htmlFor="rollno" className="text-xs font-semibold text-gray-600 uppercase tracking-wider ml-1">
                      Roll Number
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-500">
                      ...
                      <input
                        ...
                        id="rollno"
                        type="text"
                        className={`w-full bg-gray-50 border pl-10 pr-4 py-2.5 rounded-xl text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-gray-500/50 focus:border-gray-500 transition duration-200 outline-none ${errors.rollno ? "border-red-500/50" : "border-gray-200"
                          }`}
                  ...
                  {/* Class Name */}
                  <div className="space-y-1.5">
                    <label htmlFor="courseName" className="text-xs font-semibold text-gray-600 uppercase tracking-wider ml-1">
                      Class Name
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-500">
                      ...
                      <input
                        ...
                        id="courseName"
                        type="text"
                        className={`w-full bg-gray-50 border pl-10 pr-4 py-2.5 rounded-xl text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-gray-500/50 focus:border-gray-500 transition duration-200 outline-none ${errors.courseName ? "border-red-500/50" : "border-gray-200"
                          }`}

      ...
      <div className="w-full max-w-2xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5">
            ...
            <div className="md:col-span-3 p-8">
              <div className="mb-8 text-center md:text-left">
                ...
                <p className="text-gray-600 text-sm">Access your account dashboard</p>
              </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            ...
            <a href="#" className="text-gray-700 hover:text-gray-900 ml-1">Terms</a> and
            <a href="#" className="text-gray-700 hover:text-gray-900 ml-1">Privacy Policy</a>
          </p>
        </div>
      </div>
    </div>
